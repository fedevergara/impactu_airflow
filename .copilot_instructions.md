...
## Assistant Guidance
- No realizar commits automáticos en el repositorio bajo ninguna circunstancia.
- Sugerir cambios y proponer mensajes de commit es aceptable, pero solo ejecutar un commit cuando el usuario lo solicite explícitamente.

Nota: el asistente puede crear patches y mostrar exactamente qué cambios propone; el commit real debe esperar la confirmación explícita del usuario.
